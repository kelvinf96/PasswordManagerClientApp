...
class _FindPasswordPageState extends State<FindPasswordPage> {
  ...
  late String errorMessage = AppLocalizations.of(context)?.searchPasswords ?? "Password will show here";
    ...
    return Directionality(
      ...
      child: MaterialApp(
        home: Scaffold(
            ...
            appBar: AppBar(
              title: Text(AppLocalizations.of(context)?.findPassoword ?? "Find a password"),
                ...
                SizedBox(
                    ...
                    child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(AppLocalizations.of(context)?.searchPasswords ?? "Search your passwords",
                              style: TextStyle(
                  ...
                  child: SizedBox(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          ...
                          AppLocalizations.of(context)?.passwordNameTag ?? "Enter password name",
                        ),
                      )),
                ),
                Padding(
